        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5 justify-items-center mx-auto max-w-7xl w-full my-10 px-4 z-30">
          {currentItems.length > 0 ? (
            currentItems.map((funding) => (
              ...
              >
                <h2 className="text-xl font-bold text-[#04684C] pr-10 truncate w-[250px] max-[500px]:w-[200px]">
      ...
      {filteredFundings.length > itemsPerPage && (
        <div className="flex justify-center items-center gap-4 mt-5 max-[500px]:flex-col">
          <button
            ...
            className={`bg-[#04684C] text-white py-2 px-8 w-[200px] rounded-md cursor-pointer ${
              currentPage === 1
