...
const Navbar = () => {
  ...
  const handleNavClick = (navigationAction) => {
    navigationAction();
    setDisplayClas("");
  };
  ...
  return (
    <>
      <nav className="sticky z-50 left-0 right-0 bottom-0 top-0 bg-[#04684C] flex justify-between items-center w-full h-15 px-10 py-10">
        ...
        <div
          className={` ${displayClass === "active" ? "flex" : "hidden"} ${
            !isHomePage ? "hidden" : ""
          }  min-[1000px]:flex min-[1000px]:pl-25 flex justify-center items-center gap-10 text-white font-bold  font-montserat max-[1000px]:absolute max-[1000px]:top-20 max-[1000px]:left-0 max-[1000px]:right-0 max-[1000px]:w-full max-[1000px]:bg-[#04684C]/75 max-[1000px]:py-5 max-[1000px]:flex-col max-[1000px]:items-center max-[1000px]:justify-center max-[1000px]:gap-5 max-[1000px]:transition-all max-[1000px]:duration-500 max-[1000px]:ease-in-out`}
        >
          <a
            onClick={() => {
              handleNavClick(scrollToFeatured);
            }}
          ...
          <a
            onClick={() => {
              handleNavClick(handleFundingFormNavigate);
            }}
            className="cursor-pointer"
          >
            Post Request
          ...
          <a
            onClick={() => {
              handleNavClick(scrollToHowItWorks);
            }}
            className="cursor-pointer"
          >
            How It Works
        ...
        <div
          className={`${displayClass === "active" ? "block" : "hidden"} ${
            !isHomePage ? "hidden" : ""
          } min-[1000px]:flex flex justify-center max-[1000px]:absolute max-[1000px]:top-67 max-[1000px]:left-0 max-[1000px]:w-full max-[1000px]:bg-[#04684C]/75 max-[1000px]:py-5 max-[1000px]:flex-col max-[1000px]:items-center max-[1000px]:gap-5 max-[1000px]:transition-all max-[1000px]:duration-500 max-[1000px]:ease-in-out`}
        >
          <button
        ...
        <img
          ...
          className={`w-10 h-10 hidden max-[1000px]:block mr-1 cursor-pointer ${
            !isHomePage ? "max-[1000px]:hidden" : ""
          } `}
