    ...
    <div className="w-full md:w-48">
      ...
      <Listbox value={selected} onChange={setSelected}>
        <div className="relative mt-2.5">
          <Listbox.Button className="relative w-full cursor-pointer rounded-md bg-white p-2 pr-10 text-left text-sm outline-0 min-h-[40px]">
                ...
                <Listbox.Option
                  ...
                  className={({ active }) =>
                    `relative cursor-default select-none py-2 pl-10 pr-4 text-sm ${
                      active ? "bg-[#04684C] text-white" : "text-gray-900"
                    }`
                  }
                  value={option}
                >
